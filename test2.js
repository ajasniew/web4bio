 ...
 */
//returns the location (an object with x and y coordinates) of the element
//given as first parameter (canvas in this case) in the document
 ...
 */
//the getEventLocation method return the coordinates (x,y) according to the mouse event (click, mousemove etc)
//even if the user zooms on the document as the use of the getElementPosition increases the accuracy of the 
